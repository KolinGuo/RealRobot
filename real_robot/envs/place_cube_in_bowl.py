from mani_skill2.envs.pick_and_place.place_cube_in_bowl import PlaceCubeInBowlEnv
...
@register_env(
    "PlaceCubeInBowlRealXArm-v8",
    max_episode_steps=50,
    reward_mode="dense_v2",
    robot="xarm7_d435",
    image_obs_mode="hand_front",
    no_static_checks=True,
    success_needs_ungrasp=True,
    success_cube_above_only=True,
